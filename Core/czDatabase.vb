...
Public Class czDatabase
    ...
    Public Function DoFieldExist(ByRef dbConnection As SqlConnection, ByVal FieldName As String, ByVal TableName As String) As Boolean
        ...
        For Each row As DataRow In FieldList.Rows
            For Each col As DataColumn In FieldList.Columns
    ...
    End Function
    Public Function CreateField(ByRef dbConnection As SqlConnection, ByVal sTableName As String, ByVal sFieldName As String, ByVal sFieldType As String, FieldValue As Object) As Boolean
        'Crea un campo su una tabella. Se la tabella non esiste la crea.
        Dim sqlStatement As String
        Dim cmdSql As New SqlCommand()
        ...
        Try
            ...
            Else
                'Aggiungo campo
                sqlStatement = "ALTER TABLE " & sTableName & " ADD " & sFieldName & " " & sFieldType
                cmdSql.Connection = dbConnection
                cmdSql.CommandText = sqlStatement
                cmdSql.ExecuteNonQuery()

                sqlStatement = "UPDATE " & sTableName & " SET " & sFieldName & " = "
                Select Case sFieldType.ToUpper
                    Case "INT", "REAL", "BIT"
                        sqlStatement = sqlStatement & FieldValue
                    Case "IMAGE"
                    Case Else
                        sqlStatement = sqlStatement & "'" & CStr(FieldValue) & "'"
                End Select
                cmdSql.Connection = dbConnection
                cmdSql.CommandText = sqlStatement
                cmdSql.ExecuteNonQuery()
